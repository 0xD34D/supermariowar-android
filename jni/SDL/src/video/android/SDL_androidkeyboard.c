...
static SDL_Scancode Android_Keycodes[] = {
    ...
    SDL_SCANCODE_RETURN, /* 111 */
    SDL_SCANCODE_ESCAPE, /* 112 */
    SDL_SCANCODE_RIGHT,  /* 113 */
    SDL_SCANCODE_LEFT,	 /* 114 */
    SDL_SCANCODE_DOWN,	 /* 115 */
    SDL_SCANCODE_UP,	 /* 116 */
    SDL_SCANCODE_RCTRL,  /* 117 */
    SDL_SCANCODE_RSHIFT  /* 118 */
};
...
int
Android_OnKeyDown_CBS(int keycode)
{
	return SDL_SendKeyboardKey(SDL_PRESSED, keycode);
}

int
Android_OnKeyUp_CBS(int keycode)
{
