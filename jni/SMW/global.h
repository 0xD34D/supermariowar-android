...
// used to determine that this is being built for android - Clark Scheff
#define ANDROID_NDK
...
#include <algorithm>
	...
	#define LOGV(...) __android_log_print(ANDROID_LOG_VERBOSE, "SMW_JNI", __VA_ARGS__)
	#define LOGD(...) __android_log_print(ANDROID_LOG_DEBUG,   "SMW_JNI", __VA_ARGS__)
	#define LOGI(...) __android_log_print(ANDROID_LOG_INFO,    "SMW_JNI", __VA_ARGS__)
	#define LOGW(...) __android_log_print(ANDROID_LOG_WARN,    "SMW_JNI", __VA_ARGS__)
	#define LOGE(...) __android_log_print(ANDROID_LOG_ERROR,   "SMW_JNI", __VA_ARGS__)
#endif
